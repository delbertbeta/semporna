...
description: Use when deploying the semporna frontend to the staging Cloudflare R2 bucket from a local checkout using environment variables from a .env file.
---
...
- Deploying `semporna` to the staging R2 bucket
